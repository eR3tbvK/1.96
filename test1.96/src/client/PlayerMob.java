	...
	public void paintComponent(Graphics g){
		...
		if(knockedOut){
			...
			if(username.equals(clientUsername)){
				...
				if(yCoordinate >= 430 && xCoordinate >= 780){
					this.setBounds(780, 431, 150, 150);
					//this.setVisible(false);
				}else if(yCoordinate >= 430){
					this.setBounds(xCoordinate, 431, 150, 150);
					//this.setVisible(false);
				}else if(xCoordinate >= 780){
					this.setBounds(780, yCoordinate, 150, 150);
